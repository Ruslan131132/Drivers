...
void cryptoController::encrypt_login_or_password(QString password) {
    ...
    QFile out("C:\\Users\\Anna\\Desktop\\Lab_22\\out.txt");
    ...
    QFile in("C:\\Users\\Anna\\Desktop\\Lab_22\\in.txt");
...
bool cryptoController::check_password(QString password) {
    ...
    char buffer[256] = {0};
    QFile source_file("C:\\Users\\Anna\\Desktop\\Lab_22\\password_crypt.txt");
...
void cryptoController::encrypt_db_file(QString password, int record_id, int is_password)
{
    ...
    EVP_CIPHER_CTX *ctx;
        ...
        QFile file("C:\\Users\\Anna\\Desktop\\Lab_22\\db_crypt.json");
        file.open(QIODevice::WriteOnly);
